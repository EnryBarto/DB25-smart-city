...
L'applicazione è stata creata in Java 21 e la base di dati è su MySQL. Per l'interfaccia grafica è stata utilizzata la libreria Swing, mentre per l'interfacciamento al DBMS abbiamo usato JDBC.
Per migliorare l'interfaccia grafica, in particolare riguardo alla selezione delle date e delle ore, abbiamo usufruito della libreria FlatLaf \footnote{Link alla libreria, importata attraverso Gradle: \url{https://www.formdev.com/flatlaf/}}.

\section{Funzionalità di base}
Quando si entra nell'applicativo, vengono mostrate le funzionalità di base nella barra di navigazione posta sulla parte superiore della finestra.
\\
\begin{center}
\includegraphics[width=0.6\textwidth]{app/Navbar}
\end{center}
