...
\begin{itemize}
  \item Tutti i campi \texttt{prezzo} devono contenere valori $>$ 0
  \item I campi \texttt{durata} e \texttt{num\_giorni} devono contenere valori $>$ 0
...
\item \textbf{Estrazione delle linee con più multe negli ultimi 3 mesi} \\
